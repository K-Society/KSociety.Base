...
{
    public class KbIdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken> 
        : IdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>, IDbUnitOfWork 
    ...
    {
        protected readonly ILogger<KbIdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>> Logger;
        ...
        public KbIdentityDbContext(DbContextOptions option)
            : base(option)
        {
            ...
            Logger = LoggerFactory.CreateLogger<KbIdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>>();
        }

        public KbIdentityDbContext(ILoggerFactory loggerFactory, IDatabaseConfiguration configuration)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //ToDo
            optionsBuilder.ReplaceService<IMigrationsSqlGenerator, KbMigrationSqlGenerator>();
