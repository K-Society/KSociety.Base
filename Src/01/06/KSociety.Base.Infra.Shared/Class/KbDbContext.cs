...
{
    public class KbDbContext : DbContext, IDbUnitOfWork
    {
        public const string DefaultSchema = "kb";

        protected readonly ILogger<KbDbContext> Logger;
        ...
        public KbDbContext(DbContextOptions option)
            : base(option)
        {
            ...
            Logger = LoggerFactory.CreateLogger<KbDbContext>();
        }

        public KbDbContext(ILoggerFactory loggerFactory, IDatabaseConfiguration configuration, IMediator mediator)
        {
