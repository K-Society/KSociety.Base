...
namespace KSociety.Base.Srv.Behavior
{
        ...
        where TRemoveRes : class, IResponse, new()
    {
        ...
        {
            return await CommandHandlerAsync
                .ExecuteWithResponseAsync<TUpdateReq, TUpdateRes>(LoggerFactory, ComponentContext, request,
                    context.CancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await CommandHandlerAsync
                .ExecuteWithResponseAsync<TCopyReq, TCopyRes>(LoggerFactory, ComponentContext, request,
                    context.CancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await CommandHandlerAsync
                .ExecuteWithResponseAsync<TModifyFieldReq, TModifyFieldRes>(LoggerFactory, ComponentContext, request,
                    context.CancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await CommandHandlerAsync
                .ExecuteWithResponseAsync<TRemoveReq, TRemoveRes>(LoggerFactory, ComponentContext, request,
                    context.CancellationToken).ConfigureAwait(false);
        }
    }
}
