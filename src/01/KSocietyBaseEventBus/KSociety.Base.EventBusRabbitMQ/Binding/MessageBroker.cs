namespace KSociety.Base.EventBusRabbitMQ.Binding
{
        ...
        where TSubscriberClass : Subscriber, TSubscriber
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<TSubscriberClass>().UsingConstructor(typeof(IRabbitMqPersistentConnection), typeof(TEventBusParameters), typeof(int), typeof(ILogger<EventBusRabbitMq>)).WithParameter("eventBusNumber", this._eventBusNumber).WithParameter("dispatchConsumersAsync", this._dispatchConsumersAsync).As<TSubscriber>().SingleInstance();
        }
    }
}
